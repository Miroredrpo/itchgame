...
function showGameOver() {
    ...
    overlay.innerHTML = `
        <h1 style="font-size: 48px; color: #ff4d4d; margin-bottom: 20px;">Game Over</h1>
        <p style="font-size: 24px; margin-bottom: 30px;">Press R to restart</p>
    `;
...
function resetGame() {
    ...
    player = {
        ...
        jumpst: 0,
        c: 0,
        speed: 10, // Slightly reduced from original 12
        // ... keep other player properties ...
    };
...
function draw() {
    ...
    // Check for game over condition (player fell off screen)
...
if(!player.dead&&home==0){
	this.x-=(player.speed/1.4)}	
		...
		noStroke();
					...
					// Removed the overly broad death condition that was killing the player when landing on platforms
